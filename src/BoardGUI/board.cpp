...
unsigned short Board::calculateSquarestoEdge(int currPosition)
{ // XXXXBBBTTTRRRLLL
    ...
    for (int sq = 0; sq < 64; sq++)
    {
        ...
        if (curr != 0 && (piece.isWhite(curr) != black))
        {
            ...
            if ((curr & piece.pieceMask) == piece.pawn)
            {
                if (black)
                {
                    ...
                    if (movesPlayed.size() != 0)
                    {
                        ...
                        bool checkCondition = (position[last.targetSquare] == piece.whitePawn) && (std::abs(last.targetSquare - last.startingSquare) == 16);
                ...
                else
                {
                    ...
                    {
                        Move last = movesPlayed[movesPlayed.size() - 1];
                        bool checkCondition = (position[last.targetSquare] == piece.blackPawn) && (std::abs(last.targetSquare - last.startingSquare) == 16);
            ...
            if ((curr & piece.pieceMask) == piece.king)
            {
                ...
                {
                    bool isAtBorder = ((top == 0) && (i == -7 || i == -8 || i == -9)) || ((bottom == 0) && (i == 7 || i == 8 || i == 9)) || ((left == 0) && (i == -9 || i == -1 || i == 7)) || ((right == 0) && (i == 9 || i == 1 || i == -7));
                    int moveIndex = sq + i;
                    Move move = Move(sq, moveIndex);
            ...
            if ((curr & piece.pieceMask) == piece.knight)
            {
                ...
                {
                    bool isAtBorder = ((top == 0) && (i < 0)) || ((top == 1) && (i < -10)) || ((bottom == 0) && (i > 0)) || ((bottom == 1) && (i > 10)) || ((left == 0) && (i == -10 || i == 6 || i == 15 || i == -17)) || ((left == 1) && (i == -10 || i == 6)) || ((right == 0) && (i == 10 || i == -6 || i == -15 || i == 17)) || ((right == 1) && (i == 10 || i == -6));
                    int moveIndex = sq + i;
                    Move move = Move(sq, moveIndex);
